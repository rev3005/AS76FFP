/*******************************************************************************
* File Name: Clock_Encoder_24Mhz.c
* Version 2.20
*
*  Description:
...
/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_Start
********************************************************************************
*
* Summary:
...
void Clock_Encoder_24Mhz_Start(void) 
{
    ...
    Clock_Encoder_24Mhz_CLKEN |= Clock_Encoder_24Mhz_CLKEN_MASK;
	Clock_Encoder_24Mhz_CLKSTBY |= Clock_Encoder_24Mhz_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_Stop
********************************************************************************
*
* Summary:
...
void Clock_Encoder_24Mhz_Stop(void) 
{
    ...
    Clock_Encoder_24Mhz_CLKEN &= (uint8)(~Clock_Encoder_24Mhz_CLKEN_MASK);
	Clock_Encoder_24Mhz_CLKSTBY &= (uint8)(~Clock_Encoder_24Mhz_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((Clock_Encoder_24Mhz_CLKEN & Clock_Encoder_24Mhz_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = Clock_Encoder_24Mhz_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clock_Encoder_24Mhz_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Clock_Encoder_24Mhz__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Clock_Encoder_24Mhz_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clock_Encoder_24Mhz_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = Clock_Encoder_24Mhz_GetSourceRegister();
    uint16 oldDivider = Clock_Encoder_24Mhz_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clock_Encoder_24Mhz_CLKEN & Clock_Encoder_24Mhz_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(Clock_Encoder_24Mhz_DIV_PTR, clkDivider);
                Clock_Encoder_24Mhz_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                Clock_Encoder_24Mhz_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(Clock_Encoder_24Mhz_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Clock_Encoder_24Mhz_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(Clock_Encoder_24Mhz_DIV_PTR, clkDivider);
				Clock_Encoder_24Mhz_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Clock_Encoder_24Mhz_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    Clock_Encoder_24Mhz_MOD_SRC |= modeBitMask & (uint8)Clock_Encoder_24Mhz_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    Clock_Encoder_24Mhz_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Clock_Encoder_24Mhz_MODE_MASK));
}


/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return Clock_Encoder_24Mhz_MOD_SRC & (uint8)(Clock_Encoder_24Mhz_MODE_MASK);
}


/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = Clock_Encoder_24Mhz_GetDividerRegister();
    uint8 oldSrc = Clock_Encoder_24Mhz_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Clock_Encoder_24Mhz_MOD_SRC |= CYCLK_SSS;
        Clock_Encoder_24Mhz_MOD_SRC =
            (Clock_Encoder_24Mhz_MOD_SRC & (uint8)(~Clock_Encoder_24Mhz_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return Clock_Encoder_24Mhz_MOD_SRC & Clock_Encoder_24Mhz_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    Clock_Encoder_24Mhz_PHASE = clkPhase & Clock_Encoder_24Mhz_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Encoder_24Mhz_GetPhase
********************************************************************************
*
* Summary:
...
{
    return Clock_Encoder_24Mhz_PHASE & Clock_Encoder_24Mhz_PHASE_MASK;
}
